...
const ThuocController_1 = require("../controllers/ThuocController");
const router = (0, express_1.Router)();
const danhMucThuocController = new ThuocController_1.DanhMucThuocController();
const thuocController = new ThuocController_1.ThuocController();
// Danh mục thuốc
...
const tonKhoController = new ThuocController_1.TonKhoController();
...
const phieuNhapController = new ThuocController_1.PhieuNhapThuocController();
...
const chiTietPhieuNhapController = new ThuocController_1.ChiTietPhieuNhapController();
...
const chiTietDonController = new ThuocController_1.ChiTietDonThuocController();
